...
class LoadData:
    ...
    def getBrazilDataFrame(min_confirmed: int = 5, store: bool = False) -> pd.DataFrame:
        ...
        df_brazil_states_cases = pd.read_csv(
            ...
            usecols=["date", "state", "newCases", "totalCases", "deaths", "newDeaths", "recovered", "vaccinated", "vaccinated_second"],
            parse_dates=["date"],
        )
        ...
        df_brazil_states_cases.fillna(value={"vaccinated": 0}, inplace=True, downcast="int64")
        df_brazil_states_cases.fillna(value={"vaccinated_second": 0}, inplace=True, downcast="int64")
        columns_rename = {"totalCases": "confirmed", "newCases": "infected", "deaths": "cummDeaths", "newDeaths": "deaths"}
        ...
        if store == True:
            ...
            df_brazil_states_cases.to_csv(f"./" + last_date + "_Brazil_by_day.csv", index=False)
